...
DIR_RESOURCES = root_path / "frontend/resources"
...
DIR_WEB_RESULT_IMG = root_path / "frontend/image/static/input_images" # model output images with bounding boxes, web-accessible directory
